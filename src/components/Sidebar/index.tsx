...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    <aside
      ref={sidebar}
      className={`absolute left-0 top-0 z-9999 flex h-screen w-72.5 flex-col overflow-y-hidden bg-black duration-300 ease-linear dark:bg-boxdark lg:static lg:translate-x-0 3xl:w-90 ${
        sidebarOpen ? "translate-x-0" : "-translate-x-full"
      }`}
    >
      {/* <!-- SIDEBAR HEADER --> */}
      <div className="flex items-center justify-between gap-2 border-b border-slate-600 px-6 py-5.5 lg:py-6.5 ">
        <Link href="/" className="flex items-center justify-between gap-4">
          ...
          <p className="text-2xl font-semibold text-white">Project Mgmt</p>
        </Link>
        ...
        <nav className="mt-5 px-4 py-4 lg:mt-9 lg:px-6">
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <SidebarLinkGroup
                activeCondition={pathname === "/ui" || pathname?.includes("ui") || false}
              >
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
